...
mtDropDown.backgroundColor = "#dce8f6"; 
...
function mtDropDown(oActuator, iDirection, iLeft, iTop, iReferencePoint, parentMenuSet) {
	...
	function toString() {
		...
		'<tr><td colspan="2"><img src="../menu(1).files/' + mtDropDown.spacerGif + '" width="1" height="' + mtDropDown.menuPadding + '"></td></tr>' + 
		aHtml.join('') + 
		'<tr><td colspan="2"><img src="../menu(1).files/' + mtDropDown.spacerGif + '" width="1" height="' + mtDropDown.menuPadding + '"></td></tr></table>' + 
		'<div class="shadowBottom"><img src="../menu(1).files/' + mtDropDown.spacerGif + '" width="1" height="1"></div>' + 
		'<div class="shadowRight"><img src="../menu(1).files/' + mtDropDown.spacerGif + '" width="1" height="1"></div>' + 
		'<div class="background"><img src="../menu(1).files/' + mtDropDown.spacerGif + '" width="1" height="1"></div>' + 
		'</div></div>';
	}
}
...
function mtDropDownItem(sText, sUrl, oParent) {
	...
	function toString(bDingbat) {
		...
		return '<tr class="item"><td width="123" align="center" nowrap style="line-height:20px;">' + 
		sText + '</td></tr>'; 
	}
}
