...
<div class="<?php print $classes; ?>">
  ...
  <div class="view-footer form-item-div">
    ...
    <?php if (empty($covidien_reports_noresult)) { ?>
      <div class="form-item-left"><input type="button" class="form-submit secondary_submit" onclick="window.open('<?php echo $base_url . '/covidien/report/5/pdf/Audit_Trail_Report?' . $export_filter_param; ?>', '_blank');
          return true;" value="<?php echo t("Download as PDF"); ?>" id="edit-add-new"></div>
      <div class="form-item-left"><input type="button" class="form-submit secondary_submit" onclick="window.open('<?php echo $base_url . '/covidien/report/5/xls?' . $export_filter_param; ?>', '_blank');
          return true;" value="<?php echo t("Download as XLS"); ?>" id="edit-add-new"></div>
      <div class="form-item-left"><input type="button" class="form-submit secondary_submit" onclick="window.open('<?php echo $base_url . '/covidien/report/5/csv?' . $export_filter_param; ?>', '_blank');
          return true;" value="<?php echo t("Download as CSV"); ?>" id="edit-add-new"></div>
                                       <?php } ?>
    <div class="form-item-right" style="width : 50px;">
      <a href="<?php print $base_url; ?>/covidien/reports/filter/5" id="secondary_submit"><?php echo t("Return"); ?></a>
    </div>
  </div>
