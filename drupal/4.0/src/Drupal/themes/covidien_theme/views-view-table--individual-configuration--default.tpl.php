...
?>
<?php if (!empty($rows[0])): ?>
  <table class="popup_in_configuration" style="width : 900px;">
    <tr><td><h5><?php print $rows[0]['title']; ?><h5/></td>
      <td align="right" valign="top"><a class="popup_in_close" onclick="$('.ajaxtooltip').hide();" style="cursor:pointer;"><span><img src="<?php echo $base_url; ?>/sites/all/themes/covidien_theme/images/close.png" width="25px"></span></a></td>
    </tr>
  </table>
...
<table class="<?php print $class; ?>"<?php print $attributes; ?> style="width:900px">
  <?php if (!empty($rows[0])): ?>
    <thead>
      <tr>
        ...
        <?php foreach ($header as $field => $label): ?>
          ...
          switch ($fields[$field]) {
            ...
            case 'field-sw-status-nid':
              $lbl_header = true;
              break;
//field-expiration-datetime-value
//field-expiration-datetime-value-1
//field-sw-status-nid
            default:
              $lbl_header = false;
          }
...
//Condition used for Tester Permission
      ...
      if (!$istesting && $row['field_sw_status_nid'] == 'Limited Release') {
        $sw_exp = true;
      }
