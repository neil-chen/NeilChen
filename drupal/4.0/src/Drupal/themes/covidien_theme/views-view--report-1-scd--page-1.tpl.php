...
<table class="report1_noborder">
  ...
  <div class="view-footer form-item-div">
    ...
    <?php if (empty($covidien_reports_noresult)) { ?>
      <div class="form-item-left"><input type="button" class="form-submit secondary_submit" onclick="window.open('<?php echo $base_url . '/covidien/report/1/scd/pdf/Device_Current_Configuration_Report?' . $export_filter_param; ?>', '_blank');
          return true;" value="<?php echo t("Download as PDF"); ?>" id="edit-add-new"></div>
      <div class="form-item-left"><input type="button" class="form-submit secondary_submit" onclick="window.open('<?php echo $base_url . '/covidien/report/1/scd/xls?' . $export_filter_param; ?>', '_blank');
          return true;" value="<?php echo t("Download as XLS"); ?>" id="edit-add-new"></div>
      <div class="form-item-left"><input type="button" class="form-submit secondary_submit" onclick="window.open('<?php echo $base_url . '/covidien/report/1/scd/csv?' . $export_filter_param; ?>', '_blank');
