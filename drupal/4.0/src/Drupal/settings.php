 ...
 */
//$db_url = 'mysqli://covidiendbuser:C0vidi3nDrp@localhost/covidiendb20';
$db_url = 'mysql://user:pass@localhost/covidiendb';
$db_prefix = '';
global $base_log_file_path;
global $base_web_service_url;

$base_log_file_path = '/var/www/logfile/';
$base_web_service_url = 'http://localhost:8080/gatewaylog/log?path=';
...
$drupal_repourl = '127.0.0.1';
$drupal_swrepo = "software/";
$drupal_docrepo = "document/";
$alert_template_path = 'alert_template/';
$drupal_password_expiration_day = "50";
$expire_notice = "5";
$drupal_downloadrepo = "download/";
$agent_file = '/sites/default/files/software/cv_pb980vent_101R_0313.zip';
$agent_desc = 'Click here to download Agent v2.0.8';
