          ...
          function uploadNextChunk() {
            ...
            function prepareAndSend(bin) {
              ...
              xhr.onerror = function(error) {
                ...
                xhr._retry_times++;
                console.log("xhr._retry_times = " + xhr._retry_times);
              };
              ...
              xhr.onreadystatechange = function() {
                ...
                if (xhr.readyState == 4 && up.state !== plupload.STOPPED) {
                  ...
                  console.log('httpStatus' + httpStatus, xhr.responseText);
                  // Is error status
                  if (httpStatus >= 400) {
                    up.trigger('Error', {
              ...
              if (up.settings.multipart && features.multipart) {
                ...
                if (typeof (bin) !== 'string' && !!window.FormData) {
                  ...
                  // GATEWAY-2971 hack try 30 times to resend if connection reset 
                  for (i = 0; i < 30; i++) {
                    console.log("i = " + i);
                    try {
                      xhr.send(formData);
